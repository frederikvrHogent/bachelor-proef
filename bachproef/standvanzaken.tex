...
\subsection{\IfLanguageName{dutch}{Automatische classificatie}{Automatic classification}}
...
Machine learning algoritmes kunnen in het algemeen opgedeeld worden in 3 type's:
\begin{itemize}
